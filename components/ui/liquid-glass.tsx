...
interface LiquidGlassCardProps {
  ...
  /** Glass tint for Apple-style transparency */
  tint?: 'none' | 'light' | 'dark' | 'auto';
  // Interactive props for button-like usage
  onClick?: () => void;
  role?: string;
  tabIndex?: number;
...
export const LiquidGlassCard = ({
  ...
  // Glass tint background classes for Apple-style transparency
  const tintClasses = {
    none: '',
    light: 'bg-white/30',
    dark: 'bg-black/40',
    auto: 'bg-white/30 dark:bg-black/40',
  };
